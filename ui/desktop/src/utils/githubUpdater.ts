...
export class GitHubUpdater {
  private readonly owner = process.env.GITHUB_OWNER || 'inatechsrl';
  private readonly repo = process.env.GITHUB_REPO || 'ina_goose';
  private readonly bundleName = process.env.GOOSE_BUNDLE_NAME || 'Agent Core';
    ...
    try {
      ...
      const response = await fetch(this.apiUrl, {
        headers: {
          ...
          'User-Agent': `Agent-Core-Desktop/${app.getVersion()}`,
        },
